    ...
    return _Card(
      ...
      child: Column(
        ...
        children: <Widget>[
            ...
            children: <Widget>[
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    Text(scene.name, style: context.appText.body),
                    Text(
          ...
          const SizedBox(height: AppSpace.md),
          Text('快捷切换', style: context.appText.caption),
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return _Card(
      ...
      child: events.isEmpty
          ? Text('暂无事件记录', style: context.appText.artist)
          : Column(
              children: <Widget>[
                for (final NotificationEvent e in events.take(8))
                  Padding(
                    ...
                    child: Row(
                      children: <Widget>[
                        Text(e.timeLabel, style: context.appText.caption),
                        const SizedBox(width: AppSpace.sm),
                        Container(
